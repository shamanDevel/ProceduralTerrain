...
The terrain can be rendered using different textures for each biome (Fig. \ref{fig:terrainBiomes}). Furthermore, the biomes specify if and what grass is used and what trees are planted.
\begin{figure*}
	\centering
	\begin{subfigure}[b]{0.45\textwidth}
